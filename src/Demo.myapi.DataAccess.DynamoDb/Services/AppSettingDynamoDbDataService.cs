...
using Demo.myapi.Util.Options;
using System;
using System.Collections.Generic;
using System.Threading.Tasks;

namespace Demo.myapi.DataAccess.DynamoDb.Services
{
    public class AppSettingDynamoDbDataService : IAppSettingDataService
    {
        ...
        public AppSettingDynamoDbDataService(IOptions<AWSSettingOptions> awsSettingOptions)
        {
            ...
            AWSConfigsDynamoDB.Context.TypeMappings[typeof(AppSetting)] = new Amazon.Util.TypeMapping(typeof(AppSetting), "DemomyapiAppSetting");
